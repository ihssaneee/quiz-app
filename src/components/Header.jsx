      ...
      <div>
        ...
        <div className=''>
          ...
          <ul className={` ${isToggled?"flex flex-col absolute right-0 top-16 shadow-lg  bg-[#fffcfc] w-full":"hidden"} lg:flex-row lg:flex justify-end gap-4 p-4 font-medium  `}>
            <li className=''><button className={` ${isToggled? "bg-[#fffcfc] text-black":'bg-blue-500 text-white '} p-3  cursor-pointer  rounded-2xl w-24 hover:bg-blue-600`}>Log In</button></li>
